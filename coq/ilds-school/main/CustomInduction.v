...
(* Back to our induction principle on terms. We need to prove term_ind2,
   but it will be useful to first generalize it as follows,
   with Q being an auxiliary predicate on lists of terms
*)
Lemma term_ind2_gen :
...
Proof.
  ...
  intros * Hnil Hcons Hvar Happ.
  destruct t; [apply Hvar |].
  apply Happ.
  induction l; [apply Hnil |].
  apply Hcons; [| assumption].
  eapply term_ind2_gen; [apply Hnil | assumption..].
Qed.
...
Lemma term_ind2 :
  ...
  forall t, P t.
Proof.
  intro; apply term_ind2_gen; [inversion 1 |].
  intros * Ht Hall t' [-> | Ht']; [assumption |].
