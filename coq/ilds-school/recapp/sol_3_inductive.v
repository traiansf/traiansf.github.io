...
Proof.
  ...
  *  inversion H ; subst.
     ...
     destruct (eq_dec a n) ; intros; subst.
    - rewrite nb_occ_cons ; auto with arith.     
    - rewrite nb_occ_cons_neq; auto.
  * induction l.
     - simpl in *;  lia.
...
Qed.
 ...
 Lemma nb_occ_partition_le_snd : forall l a n,  a <= n -> nb_occ a (snd (partition n l)) = 0.                                Proof.
 induction l ; intros.
* reflexivity.
* destruct (le_gt_dec a n).
  + rewrite partition_snd_le_no_cons; auto.
