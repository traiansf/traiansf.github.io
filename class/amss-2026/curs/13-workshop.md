---
title: "AMSS 2026 — Lecture 13: Project Workshop / Open Q&A"
author: "Traian-Florin Șerbănuță"
date: "2026"
---

# Today: Workshop + Open Q&A

This week is a **buffer**: no new content. In-class supervised work and open questions, with one week to go before the graded defense.
...
- **Is:** time to fix, finalise, and rehearse, with the instructor on hand.
- **Isn't:** a lecture, or a place to start your slice from scratch.

If you're starting now, prioritise a **small, owned** slice over a large unfinished one.

::: notes
Set expectations. The buffer rewards students who have something to polish; for those behind, steer toward a defensible minimum rather than sprawl. Echoes the Lab 5 "small, owned" message.
:::

---

# Work On: Your Lab 6 Gaps
...
::: notes
The dry run's per-student feedback is the concrete agenda. Students who lost their gap list should reconstruct it now with the instructor. This is the most targeted prep available.
:::

---

# Work On: Documentation + Repo

The artifact points come from the repo. Finalise:

- the **directed-design narrative** (failed prompts, rejected outputs, decisions);
- the **defect log** (at least 5 substantive defects);
- the **two diagrams**, AI-generated and reviewed;
- the team **overview model** and requirements traceability.

::: notes
Point back to the project description's per-student and per-team deliverables. The narrative + defect log carry 2 points; documentation 1. This is the day to make the repo legible to an examiner.
:::
...
::: notes
The loop, turned on the defense: peer critique surfaces gaps you can't see in your own prep. Aloud practice is what separates students who know their slice from those who can defend it. Encourage teams to mock-question each other during the workshop.
:::
...
- I can **read and critique** every diagram in my slice cold.
- I can **say why** for every direction I gave AI.
- I can **walk a trace** from a requirement to a test.
